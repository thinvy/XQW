/****************************************************************************
** Meta object code from reading C++ file 'loginWin.hpp'
**
...
#error "The header file 'loginWin.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 7), // "loginIn"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 5) // "login"

    },
    "LoginWin\0loginIn\0\0login"
};
...
void LoginWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginWin::loginIn)) {
                *result = 0;
                return;
            }
        }
